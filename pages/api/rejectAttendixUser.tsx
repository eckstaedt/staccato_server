...
import AttReject, { Props } from '../../emails/AttReject';
...
const handler = async (req: any, res: any) => {
    res.setHeader("Access-Control-Allow-Origin", "*");
    const { email, name, tenant } = req.body;
    ...
    const emailHtml = render(<AttReject {...props} />);
    const mailOptions: any = {
        from: process.env.STRATO_ATTENDIX_USER,
        to: email,
        subject: `Deine Registrierung bei der Attendix Instanz '${tenant}' wurde abgelehnt!`,
        html: emailHtml,
    };
