...
import AttApprove, { Props } from '../../emails/AttApprove';
...
const handler = async (req: any, res: any) => {
    ...
    const emailHtml = render(<AttApprove {...props} />);
    const mailOptions: any = {
        from: process.env.STRATO_ATTENDIX_USER,
        to: email,
        subject: `Deine Registrierung bei der Attendix Instanz '${tenant}' wurde genehmigt`,
        html: emailHtml,
    };
