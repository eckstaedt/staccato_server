                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                            <tr>
                                <td align="center" style="color: #153643; font-size: 23px; font-weight: bold; font-family: Arial, sans-serif;">
                                    <img src="${appName === "SoS" || appName === "VoS" ? "https://dwexedvloevhzoanxefp.supabase.co/storage/v1/object/public/public/login.jpeg" : "https://dwexedvloevhzoanxefp.supabase.co/storage/v1/object/public/public/loginBlas.jpeg"}" alt="Header" width="100%" height="300" style="display: block;" />
